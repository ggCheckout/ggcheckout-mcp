  ...
  server.registerTool(
    'list_store_products',
    {
      ...
      inputSchema: {
        ...
        limit: z.number().min(1).max(1000).optional().describe('Items per page (default: 20, max: 100)'),
  ...
  server.registerTool(
    'list_feedbacks',
    {
      ...
      inputSchema: {
        ...
        page: z.number().min(1).optional().describe('Page number (default: 1)'),
        limit: z.number().min(1).max(1000).optional().describe('Items per page (default: 10, max: 50)'),
  ...
  server.registerTool(
    'validate_coupon',
    {
      ...
      inputSchema: {
        ...
        orderValue: z.number().min(0).describe('Order value in cents to check against'),
      },
    },
